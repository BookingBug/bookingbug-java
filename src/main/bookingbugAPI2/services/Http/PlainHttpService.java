...
import helpers2.hal_addon.CustomJsonRepresentationFactory;
    ...
    private static HttpServiceResponse callApi(URL url, String auth_token, String method, String contentType, Map params, boolean testingMode) throws HttpException {
        ...
        try {
            ...
            if(cache != null) {
                ...
                return new HttpServiceResponse(representationFactory.readRepresentation(HAL_JSON, reader), url.toString(), method, contentType, params, auth_token);
            }
